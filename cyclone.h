...
class Cyclone{
 ...
 private:
  ...
  // edgeArray.
  void subprocessRun(unlong maxState);
  ...
  void subprocessRunWithSpeeds(unlong maxState);
...
void  trajNextStateWithSpeeds(const unlong curState, uchar * ternState[], uchar * ternNextState[], unlong nextStates[] ,const bool knockouts[]);
  ...
  void outputTrajectory(vector<unlong> * path, int cycleIndex, bool writeFile, string outFilename, bool verbose, string tableFilename);
  ...
  void outputRandomTrajectory(vector<unlong> * path[], bool writeFile, string outFilename, bool verbose, string tableFilename, int numSteps, int numRuns);
  ...
  // filename
  void outputEdges(bool writeFile, unlong maxState, unsigned int * edges, string filename, bool verbose);
 ...
 public:
  ...
  void run(bool fileWrite, string filenameOut, int cores, bool pverbose);
  ...
  void generateEdges(bool writeFile, string filename, bool verbose);
  ...
  void generateTrajectory(bool writeFile, string outFilename, bool verbose, string inFilename, string tableFilename);
  ...
  void generateRandomTrajectory(bool writeFile, string outFilename, bool verbose, string inFilename, string tableFilename, int numRuns, int numSteps);
